...
def pro6pl_to_playlists(pro6pl_filename) -> list:
...
def main(pro6pl_filename, songs_tgz, outdir):
    os.makedirs(outdir, exist_ok=True)

    playlists = pro6pl_to_playlists(pro6pl_filename)
    if len(playlists) == 0:
...
if __name__ == "__main__":
    ...
    main(args.playlist_pro6pl, args.songs_tgz, args.outdir)
